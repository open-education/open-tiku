        ...
        <PopoverContent className="w-85 sm:w-95 p-0 shadow-2xl border-border/50" align="end" sideOffset={12}>
          ...
          <div className="p-4 space-y-4">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    {uploading ? "请稍候" : fileId ? "点击更换文件" : "支持后缀为 .jpg, .jpeg, .png, .gif, .md 的图片或普通文件, 最大 1MB"}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                value={originalFileName || "未选择文件"}
                readOnly
                className={cn("text-sm h-9", !originalFileName && "text-muted-foreground/50")}
              />
